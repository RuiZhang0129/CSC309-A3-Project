...
function NavBar() {
  ...
  return (
    <nav style={{ padding: '10px', borderBottom: '1px solid #ccc' }}>
      ...
      <Link to="/redeem" onClick={() => setMenuOpen(false)}>积分兑换</Link>
      <Link to="/redeem-qr" onClick={() => setMenuOpen(false)}>兑换二维码</Link>
      <Link to="/promotions" onClick={() => setMenuOpen(false)}>可用促销</Link>
      <Link to="/events" onClick={() => setMenuOpen(false)}>查看活动</Link>
