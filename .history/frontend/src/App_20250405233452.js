...
function NavBar() {
  ...
  return (
    <nav style={{ padding: '10px', borderBottom: '1px solid #ccc' }}>
        ...
        <div style={{ display: 'inline-block', position: 'relative' }}>
          ...
          {menuOpen && (
            <div style={{
              ...
              <div style={{ marginBottom: '5px' }}>
                <Link to="/points" onClick={() => setMenuOpen(false)}>我的积分</Link>
              </div>
              <div>
      ...
      <Link to="/my-qr" onClick={() => setMenuOpen(false)}>我的 QR 码</Link>
      <Link to="/transfer" onClick={() => setMenuOpen(false)}>积分转账</Link>
    </nav>
  );
}
