  ...
  return (
    <Router>
      ...
      <Route path="/" element={<HomePage />} />
        ...
        <Route path="/my-events" element={<ProtectedRoute allowedRoles={["manager", "superuser"]}><MyOrganizedEventListPage /></ProtectedRoute>} />
        <Route path="/my-events/:id" element={<ProtectedRoute allowedRoles={["manager", "superuser"]}><MyOrganizedEventDetailPage /></ProtectedRoute>} />
        <Route path="/my-events/:id/participants" element={<ProtectedRoute allowedRoles={["manager", "superuser"]}><MyOrganizedEventParticipantsPage /></ProtectedRoute>} />
        <Route path="/my-events/:id/award" element={<ProtectedRoute allowedRoles={["manager", "superuser"]}><MyOrganizedEventAwardPage /></ProtectedRoute>} />
