  ...
  return (
    <Router>
      ...
      <Route path="/" element={<HomePage />} />
        ...
        {/* Cashier */}
        <Route path="/cashier/create-transaction" element={<ProtectedRoute allowedRoles={["cashier", "manager", "superuser"]}><CashierCreateTransactionPage />
  </ProtectedRoute>
} />

<Route path="/cashier/process-redemption" element={
